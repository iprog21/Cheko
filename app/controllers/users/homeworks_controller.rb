  ...
  def create
    ...
    if @homework.save
      ...
      ActionCable.server.broadcast 'homework_update_channel', data: { homework: {
          ...
          tutor_samples: @homework.tutor_samples.present? ? @homework.tutor_samples.to_s.capitalize : "False",
          tutor_skills: @homework.tutor_skills.present? ? @homework.tutor_skills.to_s.capitalize : "False",
          view_bidders: @homework.view_bidders.present? ? @homework.view_bidders.to_s.capitalize : "False",
          priority: @homework.priority.present? ? @homework.priority.to_s.capitalize : "False",
          login_school: @homework.login_school.present? ? @homework.login_school.to_s.capitalize : "False",
